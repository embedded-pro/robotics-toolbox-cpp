---
description: "Produce an implementation plan for robotics-toolbox — per-file steps, interface design, test strategy, CMake, docs. No code. Best for new algorithms or multi-file work."
...
2. **Plan** — every plan must include:
   ...
   - **CMake**: `robotics_add_header_library()`, `robotics_add_coverage_sources()`;
